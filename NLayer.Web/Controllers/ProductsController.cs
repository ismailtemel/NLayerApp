...
namespace NLayer.Web.Controllers
{
    ...
    {
        // Aşağıdaki constructoru ve private alanları kapatmamızın sebebi artık servisten değil direk apiden verileri çekeceğimiz için.
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Programımızı çalıştırdıktan sonra hata aldık nedeni kodlarımızı api için tekrar düzenlememiz.
            // Mvc de ProductWithCategoryDto dönüyorduk ama api de customresponsedto döndük.
            // İkisini de başarılı bir şekilde burda çalıştırabiliriz.
            // Aşağıdaki gibi datayı alırsak ikisini de başarılı bir şekilde çalıştırabiliriz.
            // Datayı aldıktan sonra okuyabilmemizin nedeni datanın bize ProductWithCategoryDto dönmesi.
            //return View((await _services.GetProductsWithCategory()).Data);

            //Aşağıda verileri direk apiden çekeriz.
        ...
        public async Task<IActionResult> Save()
        {
            ...
            // Aşağıdaki kodda oluşturduğumuz api servisini kullandık.
            ...
            // Eğer verileri api ile alırsak mapleme işlemi yapmamamıza gerek kalmaz.
        ...
        public async Task<IActionResult> Save(ProductDto productDto)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Burda da mapleme işlemine gerek kalmaz.
        ...
        {
            // Burdaki producttan direk dto geliyor.Bu yüzden mapleme yapmıyoruz.
        ...
        public async Task<IActionResult> Remove(int id)
        {
            ...
            // Remove async direk id istediği için yukarıdaki satıra gerek kalmaz.
