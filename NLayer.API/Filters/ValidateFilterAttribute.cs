    ...
    public class ValidateFilterAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (!context.ModelState.IsValid)
            {
                ...
                // BadRequestResult ile response'nin body'sini boş göndeririz fakat biz responsenin body'sinde hata mesajlarıda göndermek istiyoruz.Bu yüzden object olanını                 seçiyoruz.BadRequestObjectResult için customresponsedto sınıfımızı döneriz.
