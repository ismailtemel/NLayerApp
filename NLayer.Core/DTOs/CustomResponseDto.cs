...
namespace NLayer.Core.DTOs
{
    ...
    {
        // Geriye bir data dnmeyeceğimiz zaman bu class , geriye birşey döneceğimiz zaman diğer classı kullanırız.
    ...
    {
        //Bazen aşağıdaki T dataya biz null data gönderebilriz dikkat edersek eğer aşağıdaki methodlarda yazıdğımız statusCode'u  gönderdiğimizde  T data null olur.
