...
namespace NLayer.Core.Repositories
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        // Aşağıda geriye direk IEnumarable dönmememizin sebebi datayı aldıktan sonra ToList döndüğümüz anda veritabanına sorguyu atar IQueryable dönen şeylerde veritabanına sorgu atılmaz bunlar memory de bizim yazmış olduğumuz lamda ifadeleri tek seferde veritabanına gönderir tabi tolist vb methodlar çağırıldıktan sonra.
